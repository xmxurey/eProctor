            ...
            if (e.getSource() == txtMsg) {
                ...
                if (e.getSource() == btnStartStop) {
                    if (btnImage.equals(startButton.toString())) {
                        boolean start = ExamHallManager.startExam(examHall);
                        ...
                        //set takeable to 0
                        ExamHallManager.finishExam(client, examHall);
                        btnStartStop.setEnabled(false);
                        //send answers
                ...
                try {
                    ...
                    if (code == Protocol.CONNECT) {
                        ...
                        try {
                            ...
                            ExamHallManager.sendVideo(client, examHall.getExamHallID());
                        } catch (Exception e1) {
                            // TODO Auto-generated catch block
                            e1.printStackTrace();
                        }
                        ...
                        for (int i = 0; i < participantSize; i++) {
                            ...
                            ExamHallManager.endStudentTakable(userID, examHallID);
                            for (int j = 0; j < 6; j++) {
