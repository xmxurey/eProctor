...
>>>>>>> FETCH_HEAD
    ...
    //Add/Edit examslot
    public static boolean addEditExamSlot(User user, String moduleCode, String examHallID,
...
=======
    ...
    //test whether a new exam slot can be add or not
    //test whether a exam slot can be change to another under the same course
    public static boolean testAddAndEditConflict(int userID, Date startTime, Date endTime,
                                                 String moduleCode) {
